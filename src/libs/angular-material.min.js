...
! function(e, t, n) {
              ...
              C = {
                  ...
                  disableScrollAround: function(e, n, i) {
                      function r(e) {
                          ...
                          e = t.element(e || d);
                          var o;
                          return i.disableScrollMask ? o = e : (o = t.element('<div class="md-scroll-mask">  <div class="md-scroll-mask-bar"></div></div>'), e.append(o)), o.on("wheel", n), o.on("touchmove", n),
                              function() {
                      ...
                      function a() {
                          ...
                          return s && t.element(d).css({
                                  ...
                                  width: "100%",
                                  top: -r + "px"
                              }), d.clientWidth < a && (d.style.overflow = "hidden"), s && (e.style.overflowY = "scroll"),
                              function() {
                                  d.style.cssText = i, e.style.cssText = n, c.scrollTop = r
                              }
                      }
                      if (i = i || {}, C.disableScrollAround._count = Math.max(0, C.disableScrollAround._count || 0), C.disableScrollAround._count++, C.disableScrollAround._restoreScroll) return C.disableScrollAround._restoreScroll;
                      var d = o[0].body,
                          s = a(),
                          c = r(n);
                      return C.disableScrollAround._restoreScroll = function() {
                  ...
                  extractElementByName: function(e, n, o, i) {
                      ...
                      var s = r(e);
                      return !s && i && l.warn(C.supplant("Unable to find node '{0}' in element '{1}'.", [n, e[0].outerHTML])), t.element(s || e)
                  },
                  ...
                  getParentWithPointerEvents: function(e) {
                      for (var t = e.parent(); y(t, "pointer-events", "none");) t = t.parent();
                      return t
                  },
  ...
  function() {
      function e(e) {
          ...
          this.respectPreAssignBindingsEnabled = function(e) {
              ...
              function i(i) {
                  if (e.$scope = i, o.controller) {
                      var s = t.extend({}, e, {
                          ...
                          c = r._createController(o, s, e);
                      n.data("$ngControllerController", c), n.children().data("$ngControllerController", c), d.controller = c
                  }
                  return a(i)
              }
              var r = this,
              ...
              var r = this.$controller(e.controller, o, !0, e.controllerAs);
              n() && e.bindToController && t.extend(r.instance, i);
              var a = r();
              return !n() && e.bindToController && t.extend(a, i), t.isFunction(a.$onInit) && a.$onInit(), a
  ...
  function() {
      ...
      function o(n, o, i) {
          ...
          var m = navigator.userAgent || navigator.vendor || e.opera,
              p = m.match(/ipad|iphone|ipod/i),
              h = m.match(/android/i),
              v = c(),
              E = "undefined" != typeof e.jQuery && t.element === e.jQuery,
              $ = {
                  handler: s,
                  register: a,
                  isAndroid: h,
                  isIos: p,
                  isHijackingClicks: (p || h) && !E && !g
              };
          return $.isHijackingClicks && ($.handler("click", {
              options: {
                  maxDistance: b
              },
              onEnd: r("click")
      ...
      function a(e, n) {
          function o(e) {
              ...
              t || e.$material || e.isIonicTap || c(e) || "mousedown" === e.type && (u(e.target) || u(document.activeElement)) || (e.preventDefault(), e.stopPropagation())
          }

          function i(e) {
              var t = 0 === e.clientX && 0 === e.clientY,
                  n = e.target && "submit" === e.target.type;
              t || e.$material || e.isIonicTap || c(e) || n ? (v = null, "label" == e.target.tagName.toLowerCase() && (v = {
                  x: e.x,
                  y: e.y
          ...
          function r(e, t) {
              var o;
              for (var i in f) o = f[i], o instanceof n && ("start" === e && o.cancel(), o[e](t, p))
          }

          function a(e) {
              if (!p) {
                  var t = +Date.now();
                  h && !s(e, h) && t - h.endTime < 1500 || (p = d(e), r("start", e))
              }
          }
          ...
          }), !E && e.isHijackingClicks && (document.addEventListener("click", i, !0), document.addEventListener("mouseup", o, !0), document.addEventListener("mousedown", o, !0), document.addEventListener("focus", o, !0), E = !0);
          var b = "mousedown touchstart pointerdown",
              $ = "mousemove touchmove pointermove",
              y = "mouseup mouseleave touchend touchcancel pointerup pointercancel";
          t.element(document).on(b, a).on($, m).on(y, g).on("$$mdGestureReset", function() {
              h = p = null
          })
      }
      ...
      var p, h, f = {},
          ...
          v = null,
          E = !1;
      t.module("material.core.gestures", []).provider("$mdGesture", n).factory("$$MdGestureHandler", r).run(a),
          n.prototype = {
          ...
          function o(e, o, i, r, a, d, s, c, l, m, u) {
              return function() {
                  function p(e) {
                      e = e || {};
                      var t = new v(e || {}),
                          n = e.multiple ? o.resolve() : o.all(y);
                      e.multiple || (n = n.then(function() {
                          var e = C.concat(M.map(E.cancel));
                          return o.all(e)
                      }));
                  ...
                  function g(e) {
                      return function() {
                          var t = arguments;
                          return M.length ? e.apply(E, t) : y.length ? y[0]["finally"](function() {
                              return e.apply(E, t)
  ...
  function() {
      ! function() {
          ...
          var g, b, v, E = /(-gt)?-(sm|md|lg|print)/g,
              $ = /\s+/g,
              y = ["grow", "initial", "auto", "none", "noshrink", "nogrow"],
              C = ["row", "column"],
      ...
      ! function(e) {
          ...
          function o(t, o) {
              ...
              function l(t) {
                  ...
                  var o = this;
                  o.name = t, o.colors = {}, o.dark = n, n(!1), C.forEach(function(t) {
          ...
          function d(t, n, o) {
              ...
              var i = new RegExp("\\.md-" + t.name + "-theme", "g"),
                  r = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue-[0-3]|shadow|default)-?(\d\.?\d*)?(contrast)?\s*\}\}'?"?/g;
              o = o.replace(r, function(e, n, o, i, r) {
              ...
              var a = new RegExp("('|\")?{{\\s*([a-zA-Z]+)-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?", "g"),
                  d = [];
              return e.forEach(["default", "hue-1", "hue-2", "hue-3"], function(e) {
                  var n = o.replace(a, function(n, o, i, r, a) {
                      var d = t.colors[i],
                          s = p[d.name],
                          c = d.hues[e];
                      return u(s[c]["color" === r ? "value" : "contrast"], a)
                  });
                  if ("default" !== e && (n = n.replace(i, ".md-" + t.name + "-theme.md-" + e)), "default" == t.name) {
                      var r = /((?:\s|>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)\.md-default-theme((?:\s|>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)/g;
                      n = n.replace(r, function(e, t, n) {
                          return e + ", " + t + n
                      })
                  }
                  d.push(n)
          ...
          var p, h = {},
              ...
              y = m("rgb(255,255,255)"),
              C = ["primary", "accent", "warn", "background"],
              M = "primary",
              T = {
                  accent: {
                      "default": "A200",
          ...
          t.module("material.core.animate", []).factory("$$forceReflow", d).factory("$$AnimateRunner", c).factory("$$rAFMutex", s).factory("$animateCss", ["$window", "$$rAF", "$$AnimateRunner", "$$forceReflow", "$$jqLite", "$timeout", "$animate", function(t, d, s, c, l, m, u) {
              function p(o, d) {
                  var c = [],
                      ...
                      g = !1,
                      M = !1;
                  p && (d.transitionStyle && c.push([i + "transition", d.transitionStyle]), d.keyframeStyle && c.push([i + "animation", d.keyframeStyle]), d.delay && c.push([i + "transition-delay", d.delay + "s"]), d.duration && c.push([i + "transition-duration", d.duration + "s"]), g = d.keyframeStyle || d.to && (d.duration > 0 || d.transitionStyle), M = !!d.addClass || !!d.removeClass, C(o, !0));
                  var T = p && (g || M);
                  E(o, d);
                  var A, w, k = !1;
                  return {
  ...
  function() {
      ...
      function o(e) {
          ...
          function r(e, o, i, r, s, c, l, m, u, p, h, f, g) {
              ...
              function A(e, t) {
                  ...
                  e.attr({
                      role: n,
                      tabIndex: "-1"
                  }), 0 === r.length && (r = e, s && (c = s)), r.attr("id", c), e.attr("aria-describedby", c), t.ariaLabel ? o.expect(e, "aria-label", t.ariaLabel) : o.expectAsync(e, "aria-label", function() {
                      if (t.title) return t.title;
                      var e = r.text().split(/\s+/);
                      return e.length > 3 && (e = e.slice(0, 3).concat("...")), e.join(" ")
                  }), a = document.createElement("div"), a.classList.add("md-dialog-focus-trap"), a.tabIndex = 0, d = a.cloneNode(!1);
                  var l = function() {
                      e.focus()
                  };
              ...
              function w(e, t) {
                  function n(e) {
                      for (; e.parentNode;) {
                          ...
                          for (var t = e.parentNode.children, i = 0; i < t.length; i++) e === t[i] || N(t[i], ["SCRIPT", "STYLE"]) || t[i].hasAttribute("aria-live") || t[i].setAttribute("aria-hidden", o);
                          n(e = e.parentNode)
                      }
                  }
                  var o = !0;
          ...
          i.$inject = ["$mdDialog", "$mdConstant"], r.$inject = ["$mdDialog", "$mdAria", "$mdUtil", "$mdConstant", "$animate", "$document", "$window", "$rootElement", "$log", "$injector", "$mdTheming", "$interpolate", "$mdInteraction"];
          var a, d;
  ...
  function() {
      function n(e, t) {
          function n(t) {
              ...
              return n && t.addClass("md-icon-left"), o && t.addClass("md-icon-right"),
                  function(t, n) {
                      e(n)
                  }
          }
      ...
      function i(e, n, o, i, r) {
          function a(a, d, s, c) {
              ...
              if (h) {
                  ...
                  h.input = d, m();
                  var y = t.element('<div class="md-errors-spacer">');
                  d.after(y);
                  var C = t.isString(s.placeholder) ? s.placeholder.trim() : "";
                  h.label || C.length || o.expect(d, "aria-label"), d.addClass("md-input"), d.attr("id") || d.attr("id", "input_" + e.nextUid()), "input" === $ && "number" === s.type && s.min && s.max && !s.step ? d.attr("step", "any") : "textarea" === $ && p(), f || u();
      ...
      function g(t) {
          ...
          return 0 === parseInt(o.opacity) ? C(t, {}) : C(t, {
              event: "leave",
              structural: !0,
              from: {
                  opacity: 1,
      ...
      var y, C, M, T, A = ["ngIf", "ngShow", "ngHide", "ngSwitchWhen", "ngSwitchDefault"]
  }(),
  function() {
      function e(e) {
          return {
      ...
      function n(e, n, o, i) {
          ...
          return {
              ...
              compile: function(a, d) {
                  ...
                  function l(n) {
                      if ("div" == n) y = t.element('<div class="md-no-style md-list-item-inner">'), y.append(a.contents()), a.addClass("md-proxy-focus");
                      else {
                          y = t.element('<div class="md-button md-no-style">   <div class="md-list-item-inner"></div></div>');
                          var o = t.element('<md-button  class="md-no-style"></md-button>');
                          p(a[0], o[0]), o.attr("aria-label") || o.attr("aria-label", e.getText(a)), a.hasClass("md-no-focus") && o.addClass("md-no-focus"), y.prepend(o), y.children().eq(1).append(a.contents()), a.addClass("_md-button-wrap")
                      }
                  ...
                  function p(e, n, i) {
                      var r = o.prefixer(["ng-if", "ng-click", "ng-dblclick", "aria-label", "ng-disabled", "ui-sref", "href", "ng-href", "rel", "target", "ng-attr-ui-sref", "ui-sref-opts", "download"]);
                  ...
                  if (a[0].setAttribute("role", "listitem"), d.ngClick || d.ngDblclick || d.ngHref || d.href || d.uiSref || d.ngAttrUiSref) l("button");
                      ...
                      for (var C, M = 0; C = r[M]; ++M)
                          if (E = a[0].querySelector(C)) {
                              v = !0;
                              break
                          }
  ...
  function() {
      ...
      d.prototype.create = function(e, n) {
          ...
          return this._$q(function(t, n) {
              e.config.locals || (e.config.locals = {}), e.config.locals.mdPanelRef = e, e._compile().then(function() {
                  e.config.disableParentScroll && (e._restoreScroll = e._$mdUtil.disableScrollAround(null, e.panelContainer, {
                      disableScrollMask: !0
                  })), e.config.panelClass && e.panelEl.addClass(e.config.panelClass), e.config.propagateContainerEvents && (e.panelContainer.css("pointer-events", "none"), e.panelEl.css("pointer-events", "all")), e._$animate.pin && e._$animate.pin(e.panelContainer, m(e.config.attachTo)), e._configureTrapFocus(), e._addStyles().then(function() {
                      t(e)
                  }, n)
              }, n)
          })
          ...
          if (e === c.absPosition.RIGHT || e === c.absPosition.LEFT) this._left = this._right = "";
          else {
          ...
          if (e === c.xPosition.CENTER) return e;
          var t = "start",
              n = "end";
      ...
      function e(e, n, o) {
          ...
          function r(o, i, r) {
              function u() {
                  r.$observe("value", function(e) {
                      ...
                      switch (g && y.removeClass(g), e) {
                          ...
                          case d:
                          case s:
                              y.addClass(g = "md-mode-" + e);
                              break;
                          default:
                              y.addClass(g = "md-mode-" + s)
                      }
                  })
              }
              ...
              var g, b = r.hasOwnProperty("disabled"),
                  ...
                  y = t.element(i[0].querySelector(".md-container"));
  ...
  function() {
      function o(e, o, i, r, a, d, s, l) {
          function m(l, m) {
              ...
              u.append('<span class="md-select-icon" aria-hidden="true"></span>'), u.addClass("md-select-value"), u[0].hasAttribute("id") || u.attr("id", "select_value_label_" + o.nextUid());
              var p = l.find("md-content");
              if (p.length || l.append(t.element("<md-content>").append(l.contents())), p.attr("role", "presentation"), m.mdOnOpen && (l.find("md-content").prepend(t.element('<div> <md-progress-circular md-mode="indeterminate" ng-if="$$loadingAsyncDone === false" md-diameter="25px"></md-progress-circular></div>')), l.find("md-option").attr("ng-show", "$$loadingAsyncDone")), m.name) {
                  var h = t.element('<select class="md-visually-hidden"></select>');
                  h.attr({
                      name: m.name,
                      "aria-hidden": "true",
                      tabindex: "-1"
                  });
                  var f = l.find("md-option");
                  t.forEach(f, function(e) {
                      var n = t.element("<option>" + e.innerHTML + "</option>");
                      e.hasAttribute("ng-value") ? n.attr("ng-value", e.getAttribute("ng-value")) : e.hasAttribute("value") && n.attr("value", e.getAttribute("value")), h.append(n)
                  }), h.append('<option ng-value="' + m.ngModel + '" selected></option>'), l.parent().append(h);
              }
              var g = o.parseAttributeBoolean(m.multiple),
                  b = g ? "multiple" : "",
                  v = '<div class="md-select-menu-container" aria-hidden="true" role="presentation"><md-select-menu role="presentation" {0}>{1}</md-select-menu></div>';
              return v = o.supplant(v, [b, l.html()]), l.empty().append(u), l.append(v), m.tabindex || m.$set("tabindex", 0),
                  function(l, m, u, p) {
                      function h() {
                      ...
                      function $(e) {
                          if (i.isNavigationKey(e)) e.preventDefault(), y(e);
                          else if (c(e, i)) {
                              e.preventDefault();
                      ...
                      k.$render = function() {
                          ...
                          if (u.mdSelectedText || u.mdSelectedHtml) e = d(u.mdSelectedText || u.mdSelectedHtml)(l), t = !0;
                          else if (!e) {
                      ...
                      u.$observe("ngMultiple", function(e) {
                          ...
                          t.isString(e) && (e = !0), C !== n && C === e || (C = e, e ? m.attr({
                              "aria-disabled": "true"
                          }).removeAttr("tabindex").off("click", y).off("keydown", $) : m.attr({
                              tabindex: u.tabindex,
                              "aria-disabled": "false"
                          }).on("click", y).on("keydown", $))
                      }), u.hasOwnProperty("disabled") || u.hasOwnProperty("ngDisabled") || (m.attr({
                          "aria-disabled": "false"
                      }), m.on("click", y), m.on("keydown", $));
                      var R = {
                          role: "listbox",
                          "aria-expanded": "false",
                          "aria-multiselectable": g && !u.ngMultiple ? "true" : "false"
                      };
      ...
      function a() {
          function e(e, n) {
              ...
              function i() {
                  var o = e.find("label");
                  o.length || (o = t.element("<label>"), e.prepend(o)), o.addClass("md-container-ignore"), o.attr("aria-hidden", "true"), n.label && o.text(n.label)
              }
              o() || i()
          }
          return {
          ...
          function i(o, i, m, u, p, h, f, g, b) {
              ...
              function E(e, r, a) {
                  ...
                  function E(e, n) {
                      ...
                      if (!n.target) throw new Error(m.supplant(C, [n.target]));
                      t.extend(n, {
                          isRemoved: !1,
                  ...
                  function w() {
                      ...
                      function d(e) {
                          var t, o = m.nodesToArray(a.optionNodes),
                      ...
                      if (!a.isRemoved) {
                          ...
                          return r.addClass("md-clickable"), a.backdrop && a.backdrop.on("click", e), p.on("keydown", t), p.on("click", u),
                              function() {
              ...
              function y(n, o, i) {
                  var c, p = o[0],
                      ...
                      M = {
                          top: $.top - C.top,
                          left: $.left - C.left,
                          right: C.right - ($.left + $.width),
                          bottom: C.bottom - ($.top + $.height)
                      },
                      T = E.width - 2 * l,
                      ...
                      _ = s(o, v),
                      x = r(i.loadingAsync);
                  c = x ? v.firstElementChild || v : A ? A : k.length ? k[0] : w.length ? w[0] : v.firstElementChild || v, v.offsetWidth > T ? v.style["max-width"] = T + "px" : v.style.maxWidth = null, y && (v.style["min-width"] = $.width + "px"), _ && g.classList.add("md-overflow");
                  var N = c;
                  ...
                  var O, P, L, R, F;
                  y ? (O = $.left, P = $.top + $.height, L = "50% 0", P + S.height > C.bottom && (P = $.top - S.height, L = "50% 100%")) : (O = $.left + D.left - D.paddingLeft + 2, P = Math.floor($.top + $.height / 2 - D.height / 2 - D.top + v.scrollTop) + 2, L = D.left + $.width / 2 + "px " + (D.top + D.height / 2 - v.scrollTop) + "px 0px", R = Math.min($.width + D.paddingLeft + D.paddingRight, T), F = e.getComputedStyle(h)["font-size"]);
                  var B = p.getBoundingClientRect(),
                      U = Math.round(100 * Math.min($.width / S.width, 1)) / 100,
                      j = Math.round(100 * Math.min($.height / S.height, 1)) / 100;
                  return {
                      container: {
                          element: t.element(p),
                          styles: {
                              left: Math.floor(a(C.left, O, C.right - B.width)),
                              top: Math.floor(a(C.top, P, C.bottom - B.height)),
                              "min-width": R,
                              "font-size": F
                          }
                      },
                      dropDown: {
                          ...
                          styles: {
                              transformOrigin: L,
                              transform: i.alreadyOpen ? "" : m.supplant("scale({0},{1})", [U, j])
                          }
                      }
                  }
              }
      ...
      function i(e, o, i, r, a, d, s, c, l, m, u, p, h) {
          function f(s, f, g, b) {
              ...
              function E(e) {
                  ...
                  var i = $(n, e);
                  return e && (N = u[0].activeElement, k = a.getLastInteractionType()), y(e), S = m.all([e && w ? d.enter(w, n) : w ? d.leave(w) : m.when(!0), d[e ? "removeClass" : "addClass"](f, "md-closed")]).then(function() {
                      s.isOpen && (h(function() {
      ...
      function o(e, n, o, i, r, a, d, s, c, l) {
          function m(e, n) {
              var i = t.element(e[0].getElementsByClassName("md-slider-wrapper")),
                  r = n.tabindex || 0;
              return i.attr("tabindex", r), (n.disabled || n.ngDisabled) && i.attr("tabindex", -1), e.attr("role", "slider"), o.expect(e, "aria-label"), u
          }
          ...
          function u(o, m, u, p) {
              ...
              function $() {
                  if (ie && !Y() && !t.isUndefined(le)) {
                      ...
                      var i = M();
                      !i || i.height || i.width || (C(), i = he), ue[0].width = i.width, ue[0].height = i.height;
                      for (var r, a = 0; a <= o; a++) {
              ...
              function I(e) {
                  if (!Y()) {
                      m.addClass("md-active"), m[0].focus(), C();
              ...
              var W = p[0] || {
                  ...
                  te = (t.element(m[0].getElementsByClassName("md-slider-content")), i.throttle(C, 5e3)),
                  ne = 3,
      ...
      function e(e, n, o, i, r, a, d) {
          function s(e, s) {
              ...
              return e.addClass("md-dragging"),
                  function(e, s, c, m) {
                      function u(t) {
                          b && b(e) || (t.stopPropagation(), s.addClass("md-dragging"), y = {
                      ...
                      function p(e) {
                          if (y) {
                              ...
                              var t = e.pointer.distanceX / y.width,
                                  n = g.$viewValue ? 1 + t : t;
                              n = Math.max(0, Math.min(1, n)), v.css(o.CSS.TRANSFORM, "translate3d(" + 100 * n + "%,0,0)"), y.translate = n
                          }
                      }
                      ...
                      function h(t) {
                          if (y) {
                              ...
                              var n = g.$viewValue ? y.translate < .5 : y.translate > .5;
                              n && f(!g.$viewValue), y = null, e.skipToggle = !0, d(function() {
                                  e.skipToggle = !1
                              }, 1)
                          }
                      }
      ...
      function e() {
          ...
          function t(e, t) {
              var i, r, a = e.canvas,
                  d = o(e) - a.clientWidth,
                  s = n(e);
              for (i = 0; i < s.length, s[i] <= t + a.clientWidth; i++) r = s[i];
              return Math.min(d, r)
          }
          ...
          function o(e) {
              var t, n, o = 0;
              for (t = 0; t < e.tabs.length; t++) n = e.tabs[t], o += n.offsetWidth;
              return o
          }
          return {
  ...
  function() {
      ...
      function n(e) {
          ...
          o.$inject = ["$mdToast", "$scope"], i.$inject = ["$animate", "$mdToast", "$mdUtil", "$mdMedia"];
          var r, a = "ok",
              d = e("$mdToast").setDefaults({
              ...
              link: function(d, s, c) {
                  function l() {
                      ...
                      function m(e) {
                          ...
                          y(), b = Math.min(h / E, Math.max(0, b + t - v)), s.css(n.CSS.TRANSFORM, a([-b * E])), f.css(n.CSS.TRANSFORM, a([(h - b) * E])), v = t, o.nextTick(function() {
  ...
  function() {
      function n(e, n, o, i, r, a, d, s) {
          function c(c, g, b) {
              ...
              var k, _, x, N, S, D, I = "md-tooltip-" + a.nextUid(),
  ...
  function() {
      ...
      o.prototype.register = function(e) {
          ...
          if (!(t === this.scrollOffset || t > this.scrollSize - this.size)) {
              ...
              if (n) {
                  var o = Math.max(0, Math.floor(t / n) - s),
          ...
          var a, d, s = [],
              c = [];
          for (a = this.newStartIndex; a < this.newEndIndex && null == this.blocks[a]; a++) d = this.getBlock_(a), this.updateBlock_(d, a), s.push(d);
          for (; null != this.blocks[a]; a++) this.updateBlock_(this.blocks[a], a);
          for (var l = a - 1; a < this.newEndIndex; a++) d = this.getBlock_(a), this.updateBlock_(d, a), c.push(d);
          if (s.length && this.parentNode.insertBefore(this.domFragmentFromBlocks_(s), this.$element[0].nextSibling), c.length && this.parentNode.insertBefore(this.domFragmentFromBlocks_(c), this.blocks[l] && this.blocks[l].element[0].nextSibling), this.$browser.$$checkUrlChange = this.browserCheckUrlChange, this.startIndex = this.newStartIndex, this.endIndex = this.newEndIndex, this.isFirstRender) {
              this.isFirstRender = !1;
              var m = this.$attrs.mdStartIndex ? this.$scope.$eval(this.$attrs.mdStartIndex) : this.container.topIndex;
      ...
      function e(e, d, s, c, l, m, u, p, h, f, g, b) {
          ...
          function $() {
              ...
              var c, l = (e.dropdownItems || i) * o,
                  ...
                  v = m.width,
                  E = t(),
                  y = e.dropdownPosition;
              if (y || (y = f > g && p.height - f - r < l ? "top" : "bottom"), h.mdFloatingLabel && (b += a, v -= 2 * a), c = {
                      left: b + "px",
                      minWidth: v + "px",
                      maxWidth: Math.max(m.right - p.left, p.right - m.left) - r + "px"
                  }, "top" === y) c.top = "auto", c.bottom = g + "px", c.maxHeight = Math.min(l, m.top - p.top - r) + "px";
              else {
                  var C = p.bottom - m.bottom - r + s.getViewportTop();
                  c.top = f - E + "px", c.bottom = "auto", c.maxHeight = Math.min(l, C) + "px"
              }
          ...
          function q(e) {
              xe = !0, Q() && re() && ve(), Ce.hidden = X(), ye("ngFocus", {
                  $event: e
              })
          }
          ...
          function z(t) {
              switch (t.keyCode) {
                  case c.KEY_CODE.DOWN_ARROW:
                      ...
                      t.stopPropagation(), t.preventDefault(), Ce.index = Math.min(Ce.index + 1, Ce.matches.length - 1), he(), ue(!1, He.Selected);
                      break;
                  case c.KEY_CODE.UP_ARROW:
                      if (Ce.loading) return;
                      t.stopPropagation(), t.preventDefault(), Ce.index = Ce.index < 0 ? Ce.matches.length - 1 : Math.max(0, Ce.index - 1), he(), ue(!1, He.Selected);
                      break;
                  case c.KEY_CODE.TAB:
                      if (D(), Ce.hidden || Ce.loading || Ce.index < 0 || Ce.matches.length < 1) return;
                      de(Ce.index);
                      break;
                  case c.KEY_CODE.ENTER:
                      if (Ce.hidden || Ce.loading || Ce.index < 0 || Ce.matches.length < 1) return;
                      if (ne()) return;
                      t.stopPropagation(), t.preventDefault(), de(Ce.index);
                      break;
                  case c.KEY_CODE.ESCAPE:
                      if (t.preventDefault(), !Z()) return;
                      t.stopPropagation(), ce(), e.searchText && J("clear") && le(), Ce.hidden = !0, J("blur") && j(!0)
              }
          }
          ...
          function ue(e, t) {
              var n = e ? "polite" : "assertive",
                  o = [];
              t & He.Selected && Ce.index !== -1 && o.push(ie()), t & He.Count && o.push(f.resolve(pe())), f.all(o).then(function(e) {
                  b.announce(e.join(" "), n)
              })
          }
          ...
          function be() {
              ...
              return Ce.hasNotFound && !te() && (!Ce.loading || fe()) && e >= W() && (xe || ke) && !ne()
          }

          function ve() {
              var t = e.searchText || "",
                  n = t.toLowerCase();
              !e.noCache && we[n] ? Ee(we[n]) : me(t), Ce.hidden = X()
          }
  ...
  function() {
      ! function() {
          ...
          function n(e, n, o, r, a, d, s, c, l) {
              ...
              var m, u = t.bind(this, this.handleKeyEvent);
          ...
          n.prototype.$onInit = function() {
              this._mode && r.hasOwnProperty(this._mode) ? (this.currentView = r[this._mode], this.mode = this._mode) : (this.currentView = this._currentView || "month", this.mode = null);
  ...
  function() {
      ! function() {
          function e() {
              return {
                  template: '<table aria-hidden="true" class="md-calendar-day-header"><thead></thead></table><div class="md-calendar-scroll-mask"><md-virtual-repeat-container class="md-calendar-scroll-container" md-offset-size="' + (i - o) + '"><table role="grid" tabindex="0" class="md-calendar" aria-readonly="true"><tbody md-calendar-month-body role="rowgroup" md-virtual-repeat="i in monthCtrl.items" md-month-offset="$index" class="md-calendar-month" md-start-index="monthCtrl.getSelectedMonthIndex()" md-item-size="' + o + '"><tr aria-hidden="true" md-force-height="\'' + o + "px'\"></tr></tbody></table></md-virtual-repeat-container></div>",
          ...
          n.prototype.initialize = function(e) {
              ...
              e.$scope.$on("md-calendar-parent-changed", function(t, n) {
                  e.calendarCtrl.changeSelectedDate(n), e.changeDisplayDate(n)
  ...
  function() {
      ! function() {
          function e() {
              return {
                  template: '<div class="md-calendar-scroll-mask"><md-virtual-repeat-container class="md-calendar-scroll-container"><table role="grid" tabindex="0" class="md-calendar" aria-readonly="true"><tbody md-calendar-year-body role="rowgroup" md-virtual-repeat="i in yearCtrl.items" md-year-offset="$index" class="md-calendar-year" md-start-index="yearCtrl.getFocusedYearIndex()" md-item-size="' + o + '"><tr aria-hidden="true" md-force-height="\'' + o + "px'\"></tr></tbody></table></md-virtual-repeat-container></div>",
          ...
          n.$inject = ["$element", "$scope", "$animate", "$q", "$$mdDateUtil", "$mdUtil"], t.module("material.components.datepicker").directive("mdCalendarYear", e);
          var o = 88;
          n.prototype.initialize = function(e) {
              this.items = {
              ...
              var e = this;
              e.$scope.$on("md-calendar-parent-changed", function(t, n) {
                  e.calendarCtrl.changeSelectedDate(n ? e.dateUtil.getFirstDateOfMonth(n) : n), e.changeDate(n)
      ...
      ! function() {
          ...
          o.prototype.$onInit = function() {
              ...
              if (this.isCalendarOpen) {
                  var n = this;
                  n.detachCalendarPane(), n.ngModelCtrl.$setTouched(), n.evalAttr("ngBlur"), n.documentElement.off("click touchstart", n.bodyClickHandler), e.removeEventListener(n.windowEventName, n.windowEventHandler), n.calendarPaneOpenedFrom = null, n.openOnFocus ? n.$mdUtil.nextTick(t) : t()
              }
  ...
  function() {
      ...
      function i(n, o, i, r, a, d) {
          function s(e) {
              ...
              if (y.test(e) || C.test(e)) return h(e).then(m(e));
          ...
          function o(e, o, a, d, s, c, l, m, u, p) {
              ...
              function g(n, i, r) {
                  ...
                  function E() {
                      ...
                      var d = r.menuContentEl[0].querySelector(y.buildSelector(["md-menu-focus-target", "md-autofocus"]));
                      if (!d)
                          for (var s = r.menuContentEl[0].children.length, c = 0; c < s; c++) {
              ...
              function $(t, o) {
                  ...
                  var c, l = t[0],
                      ...
                      g = o.target[0].querySelector(y.buildSelector("md-menu-origin")) || o.target[0],
                      ...
                      C = o.mdMenuCtrl.positionMode();
                  "target" != C.top && "target" != C.left && "target-right" != C.left || (c = a(), c && (c = c.firstElementChild || c, c = c.querySelector(y.buildSelector("md-menu-align-target")) || c, E = c.getBoundingClientRect(), $ = {
                  ...
                  switch (C.top) {
                      ...
                      case "bottom":
                          ...
                          break;
                      default:
                          throw new Error('Invalid target mode "' + C.top + '" specified for md-menu on Y axis.')
                  }
                  var A = "rtl" == e.bidi();
                  switch (C.left) {
                      case "target":
                      ...
                      case "left":
                          ...
                          break;
                      default:
                          throw new Error('Invalid target mode "' + C.left + '" specified for md-menu on X axis.')
                  }
      ...
      function e(e, n, o) {
          return {
              ...
              compile: function(n, i) {
                  ...
                  var d = i.type,
                      s = "md-in-menu-bar";
                  if ("checkbox" != d && "radio" != d || !n.hasClass(s)) r("role", "menuitem", n[0].querySelector("md-button, button, a"));
                  else {
          ...
          function d(a, d, E) {
              function $(t, o, r, d, s, l) {
                  ...
                  o === t ? h(o) : T = p(function A() {
                      var n = e.Math.max(0, e.Math.min(i.now() - g, y));
                      h($(n, t, b, y)), f === D && n < y && (T = p(A))
                  })
              }
              ...
              var T, A, w = d[0],
                  ...
                  S = 0,
                  D = 0;
              o(d), d.toggleClass(b, E.hasOwnProperty("disabled")), a.mdMode === g && C(), a.$on("$destroy", function() {
                  M(), T && h(T)
                  ...
                  var n = e[1],
                      o = e[2],
                      i = t[2];
                  if (o !== i && d.toggleClass(b, !!o), o) M();
                  else if (n !== f && n !== g && (n = g, E.$set("mdMode", n)), n === g) C();
                  else {
                      var r = l(e[0]);
      ...
      function e(e, o, i, r, a, d, s, c, l, m, u, p) {
          ...
          function f() {
              he.selectedIndex = he.selectedIndex || 0, g(), v(), b(), m(o), d.nextTick(function() {
                  ge = j(), de(), oe(), se(), he.tabs[he.selectedIndex] && he.tabs[he.selectedIndex].scope.select(), Ee = !0, Q()
              })
          }
          ...
          function g() {
              ...
              n.html(e), l(n.contents())(he.parent), delete c.$mdTabsTemplate
          }
          ...
          function $(e, t) {
              ...
              t && X(e, t), c.hasOwnProperty(o) && n(c[o]), c.$observe(o, n)
          }
          ...
          function C(e) {
              var n = j();
              t.element(n.wrapper).toggleClass("md-stretch-tabs", V()), se()
          }
          ...
          function k(n) {
              var o = j(),
                  i = (he.shouldCenterTabs || pe() ? "" : "-") + n + "px";
              i = i.replace("--", ""), t.element(o.paging).css(r.CSS.TRANSFORM, "translate3d(" + i + ", 0, 0)"), e.$broadcast("$mdTabsPaginationChanged")
          }
          ...
          function D(e) {
              switch (e.keyCode) {
                  ...
                  case r.KEY_CODE.ENTER:
                      e.preventDefault(), fe || I(he.focusIndex);
                      break;
                  case r.KEY_CODE.TAB:
                      he.focusIndex !== he.selectedIndex && (he.focusIndex = he.selectedIndex)
              }
          }
          ...
          function O() {
              if (he.canPageForward()) {
                  var e = p.increasePageOffset(j(), he.offsetLeft);
                  he.offsetLeft = le(e)
              }
          }
          ...
          function P() {
              if (he.canPageBack()) {
                  var e = p.decreasePageOffset(j(), he.offsetLeft);
                  he.offsetLeft = le(e)
              }
          }
          ...
          function B(e) {
              if (!ve) {
                  ...
                  ae(), he.selectedIndex === t && (n.scope.deselect(), he.tabs[he.selectedIndex] && he.tabs[he.selectedIndex].scope.select()), d.nextTick(function() {
          ...
          function U(e, n) {
              var o = Ee,
                  ...
                  r = t.extend(i, e);
              return t.isDefined(n) ? he.tabs.splice(n, 0, r) : he.tabs.push(r), ie(), re(), d.nextTick(function() {
          ...
          function z() {
              ...
              return pe() ? he.offsetLeft < e.paging.offsetWidth - e.canvas.offsetWidth : t && t.offsetLeft + t.offsetWidth > e.canvas.clientWidth + he.offsetLeft
          }
          ...
          function V() {
              switch (he.stretchTabs) {
                  ...
                  case "never":
                      return !1;
                  default:
                      return !he.shouldPaginate && i.matchMedia("(max-width: 600px)").matches
              }
          }
          ...
          function K() {
              if (he.noPagination || !Ee) return !1;
              var e = o.prop("clientWidth");
              return t.forEach(j().tabs, function(t) {
                  e -= t.offsetWidth
              }), e < 0
          }
          ...
          function G(e) {
              if (e === -1) return -1;
              var t, n, o = Math.max(he.tabs.length - e, e);
              for (t = 0; t <= o; t++) {
                  if (n = he.tabs[e + t], n && n.scope.disabled !== !0) return n.getIndex();
                  if (n = he.tabs[e - t], n && n.scope.disabled !== !0) return n.getIndex()
              }
              return e
          }
          ...
          function te(e, t) {
              var n, o = t ? "focusIndex" : "selectedIndex",
                  i = he[o];
              for (n = i + e; he.tabs[n] && he.tabs[n].scope.disabled; n += e);
              n = (i + e + he.tabs.length) % he.tabs.length, he.tabs[n] && (he[o] = n)
          }

          function ne() {
              he.styleTabItemFocus = "keyboard" === u.getLastInteractionType(), j().tabs[he.focusIndex].focus()
          }

          function oe(e) {
              var n = j();
              if (t.isNumber(e) || (e = he.focusIndex), n.tabs[e] && !he.shouldCenterTabs) {
                  var o = n.tabs[e],
                      i = o.offsetLeft,
                      r = o.offsetWidth + i,
                      a = 32;
                  ...
                  if (pe()) {
                      var d = Z(Array.prototype.slice.call(n.tabs, 0, e)),
                          s = Z(Array.prototype.slice.call(n.tabs, 0, e + 1));
                      he.offsetLeft = Math.min(he.offsetLeft, le(d)), he.offsetLeft = Math.max(he.offsetLeft, le(s - n.canvas.clientWidth))
          ...
          function re() {
              for (var e = !1, t = 0; t < he.tabs.length; t++)
                  if (he.tabs[t].hasContent) {
                      e = !0;
                      break
                  }
              he.hasContent = e
          ...
          function de() {
              if (!he.dynamicHeight) return o.css("height", "");
              if (!he.tabs.length) return be.push(de);
              var e = j(),
              ...
              if (c !== a) {
                  "bottom" === o.attr("md-align-tabs") && (c -= r, a -= r, o.attr("md-border-bottom") !== n && ++c), fe = !0;
                  var l = {
                          height: c + "px"
                      },
                      m = {
          ...
          function se() {
              var e = j();
              if (!e.tabs[he.selectedIndex]) return void t.element(e.inkBar).css({
                  left: "auto",
                  right: "auto"
              });
              if (!he.tabs.length) return be.push(he.updateInkBarStyles);
              if (!o.prop("offsetParent")) return S();
              var n = he.selectedIndex,
          ...
          function le(e) {
              ...
              return pe() ? (e = Math.min(t.paging.offsetWidth - t.canvas.clientWidth, e), e = Math.max(0, e)) : (e = Math.max(0, e), e = Math.min(o - t.canvas.clientWidth, e)), e
          }
          ...
          function ue(e) {
              if (e.hasContent) {
                  ...
                  t.element(n).attr("aria-controls", he.tabContentPrefix + e.id)
              }
          }
